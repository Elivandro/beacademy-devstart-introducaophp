...
<?php
    $produto1 = ["id" => 1,
            "nome" => "<strong>Oneplus 10 Pro</strong>",
            "preco" => "R$ 6.999,00",
    ...
    $produto2 = ["id" => 2,
            "nome" => "<strong>Xiaomi Redmi 11T Pro</strong>",
            "preco" => "R$ 1.599,99",
    ...
    $produto3 = ["id" => 3,
            "nome" => "<strong>Samsung Galaxy S21 Ultra</strong>",
            "preco" => "R$ 8.549,10",
    ...
    $produto4 = ["id" => 4,
            "nome" => "<strong>Apple iPhone 12 Pro Max</strong>",
            "preco" => "R$ 8.169,05",
    ...
    $produto5 = ["id" => 5,
            "nome" => "<strong>Motorola Edge 30</strong>",
            "preco" => "R$ 5.699,05",
            ...
            <?php
                    foreach($produtos as $produto){
                        ...
                        echo "<tr>
                            ...
                            echo "<div id='JanelaModal{$produto['id']}' class='modal' tabindex='-1' role='dialog'>
